 ...
 *
 * DocumentCollection is an interface for sequentially reading 
 * individual document files from a collection file.
 */
public interface DocumentCollection {
	 ...
	 */
	public abstract List<Object> nextDocument() throws IOException;
}